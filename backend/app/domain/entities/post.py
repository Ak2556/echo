...
class Post:
    ...
    def is_scheduled(self) -> bool:
        ...
        return (
            ...
            and self.status == PostStatus.DRAFT
        )
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "Post":
        ...
        if "content" in data:
            ...
            data["content"] = PostContent(
                **{k: v for k, v in content_data.items() if hasattr(PostContent, k)}
            )

        if "metrics" in data:
            metrics_data = data["metrics"]
            data["metrics"] = PostMetrics(
                **{k: v for k, v in metrics_data.items() if hasattr(PostMetrics, k)}
            )
