...
class PostRepository(ABC):
    ...
    async def get_user_feed(self,
                            ...
                            offset: int = 0,
                            limit: int = 20,
                            include_own_posts: bool = True) -> List[Post]:
        """
    ...
    async def get_trending_posts(self,
                                 ...
                                 limit: int = 20,
                                 min_engagement: int = 5) -> List[Post]:
        """
    ...
    @abstractmethod
    async def get_posts_mentioning_user(self,
                                        user_id: str,
                                        offset: int = 0,
                                        limit: int = 20) -> List[Post]:
        """
    ...
    async def search_posts(self,
                           ...
                           date_to: Optional[datetime] = None) -> List[Post]:
        """
    ...
    @abstractmethod
    async def get_popular_hashtags(self,
                                   limit: int = 20,
