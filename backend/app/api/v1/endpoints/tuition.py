...
from ....models.tuition import (
    TuitionSession, TuitionSessionCreate, TuitionSessionUpdate,
    ...
    Quiz, QuizCreate, QuizAttempt,
    ProgressReport, SessionStatus
)
...
async def start_session(
    ...
    session = await tuition_service.start_session(
        session_id=session_id,
        teacher_id=current_user.id
    )
...
async def create_quiz(
    ...
    quiz = await tuition_service.create_quiz(
        quiz_data=quiz_data,
        teacher_id=current_user.id
    )
...
async def start_quiz_attempt(
    ...
    attempt = await tuition_service.start_quiz_attempt(
        quiz_id=quiz_id,
        student_id=current_user.id
    )
