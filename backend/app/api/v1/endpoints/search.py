    ...
    "posts": [
        {
            ...
            "content": "Welcome to Echo platform",
            "author": "John Doe",
        },
        {
            "id": 2,
            "title": "Advanced Features",
            "content": "Exploring advanced search",
            "author": "Jane Smith",
        },
        {
            "id": 3,
            "title": "Best Practices",
            "content": "How to use Echo effectively",
            "author": "Bob Johnson",
        },
    ],
    "files": [
...
async def advanced_search(
    ...
    if search_type in [SearchType.ALL, SearchType.FILES]:
        file_results = [file for file in mock_data["files"] if query_lower in file["name"].lower()]
