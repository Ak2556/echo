...
async def get_system_logs(limit: int = 100):
    ...
    return {
        "logs": [
            {"timestamp": "2025-10-12T10:30:00Z", "level": "INFO", "message": "User login successful"},
            {"timestamp": "2025-10-12T10:25:00Z", "level": "WARNING", "message": "High memory usage detected"},
        ]
    }
