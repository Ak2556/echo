...
class Settings:
    ...
    def __init__(self):
        ...
        self.SECRET_KEY = os.getenv(
            "SECRET_KEY", "your-secret-key-here-make-it-at-least-32-characters-long"
        )
        if (
            self.SECRET_KEY == "your-secret-key-here-make-it-at-least-32-characters-long"
        ...
        self.FEATURE_IMAGE_GENERATION = (
            os.getenv("FEATURE_IMAGE_GENERATION", "True").lower() == "true"
        )
