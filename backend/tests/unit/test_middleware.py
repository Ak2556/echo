...
class TestCORSMiddleware:
    ...
    async def test_cors_actual_request(self):
        ...
        middleware = CORSMiddleware(
            None, allow_origins=["http://localhost:3000"], allow_credentials=True
        )
    ...
    async def test_cors_origin_not_allowed(self):
        ...
        middleware = CORSMiddleware(None, allow_origins=["http://localhost:3000"])
    ...
    async def test_cors_expose_headers(self):
        ...
        middleware = CORSMiddleware(
            None, allow_origins=["*"], expose_headers=["X-Custom-Header", "X-Another-Header"]
        )
