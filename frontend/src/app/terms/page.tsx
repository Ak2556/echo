      ...
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <div style={{ lineHeight: 1.7 }}>
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                By accessing or using Echo ("the Service"), you agree to be bound by these Terms of Service 
                ("Terms"). If you disagree with any part of these terms, you may not access the Service.
              </p>
              <p>
                These Terms apply to all visitors, users, and others who access or use the Service, 
                including users who contribute content, information, and other materials or services.
              </p>
            </div>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
                ...
                <li>Share content including text, images, videos, and other media</li>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                To use certain features of Echo, you must create an account. When creating an account, you agree to:
              </p>
              <ul style={{ paddingLeft: '1.5rem', marginBottom: '1rem' }}>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <p style={{ marginBottom: '1rem' }}>
                You are responsible for all content you post on Echo. You agree not to post content that:
              </p>
              <ul style={{ paddingLeft: '1.5rem', marginBottom: '1.5rem' }}>
                ...
                <li>Is sexually explicit or contains nudity (except in artistic contexts)</li>
              ...
              <p style={{ marginBottom: '1rem' }}>
                You retain ownership of content you post on Echo. However, by posting content, you grant 
                Echo a worldwide, non-exclusive, royalty-free license to use, reproduce, modify, adapt, 
                publish, translate, and distribute your content in connection with the Service.
              </p>
              <p>
                This license ends when you delete your content or account, except for content that has 
                been shared with others and they have not deleted.
              </p>
            </div>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                You agree not to use Echo for any of the following prohibited activities:
              </p>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                ...
                protect your information when you use the Service. By using Echo, you agree to the 
                collection and use of information in accordance with our Privacy Policy.
              </p>
              <p>
                We implement appropriate security measures to protect your personal information, but 
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                The Service and its original content, features, and functionality are owned by Echo 
              ...
              <p>
                If you believe your intellectual property rights have been violated, please contact 
                us at legal@echo.com with details of the alleged infringement.
              </p>
            </div>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p style={{ marginBottom: '1rem' }}>
                The Service is provided on an "AS IS" and "AS AVAILABLE" basis. Echo makes no 
              ...
              <p style={{ marginBottom: '1rem' }}>
                Echo shall not be liable for any indirect, incidental, special, consequential, or 
                punitive damages, including without limitation, loss of profits, data, use, goodwill, 
                or other intangible losses.
              </p>
              <p>
                In no event shall Echo's total liability to you for all damages exceed the amount 
                you paid to Echo in the last twelve months, or $100, whichever is greater.
              </p>
            </div>
          </section>
          ...
          <section style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <div style={{
                ...
                <p><strong>Email:</strong> legal@echo.com</p>
                <p><strong>Address:</strong> Echo Inc., 123 Terms Street, San Francisco, CA 94105</p>
        ...
        <footer style={{
          ...
          <p style={{
            ...
            These terms are effective as of December 2024 and apply to all users of Echo.
          </p>
        </footer>
      </div>
    </div>
