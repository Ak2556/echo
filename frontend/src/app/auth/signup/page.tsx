...
import { Mail, Lock, User, ArrowRight, CheckCircle2, UserPlus } from 'lucide-react';
        ...
        >
          <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 p-8 md:p-10">
            ...
            <div className="text-center mb-8">
              ...
              <p className="text-gray-600 dark:text-gray-400">Join Echo and start connecting</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <Input
                ...
                success={touchedFields.full_name && !errors.full_name && watchedName ? 'Looks good!' : undefined}
                icon={<User size={18} />}
              ...
              <div className="flex items-start gap-3">
                ...
                <label className="text-sm text-gray-600 dark:text-gray-400">
                  I agree to the{' '}
                  <Link href="/terms" className="text-purple-600 hover:text-purple-700 dark:text-purple-400 font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-purple-600 hover:text-purple-700 dark:text-purple-400 font-medium">
                    Privacy Policy
                  </Link>
                </label>
              </div>
