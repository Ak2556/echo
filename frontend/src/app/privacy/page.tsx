    ...
    >
      <div style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <header style={{ textAlign: 'center', marginBottom: '3rem' }}>
          ...
          >
            Your privacy is important to us. This policy explains how Echo
        ...
        <div style={{ lineHeight: 1.7 }}>
          <section id="information-we-collect" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <ul style={{ paddingLeft: '1.5rem' }}>
                ...
                <li>
                  Public databases and data brokers (where legally permitted)
                </li>
              </ul>
            </div>
          </section>
          ...
          <section id="information-sharing" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <ul style={{ paddingLeft: '1.5rem' }}>
                ...
                <li>
                  <strong>Public content:</strong> Information you choose to
                  make public on Echo
                </li>
              </ul>
            </div>
          ...
          <section id="your-rights" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              <p style={{ marginTop: '1rem' }}>
                To exercise these rights, contact us at privacy@echo.com or use
          ...
          >
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p>
                Echo operates globally, and your information may be transferred
              ...
              <ul style={{ paddingLeft: '1.5rem', marginTop: '1rem' }}>
                ...
                <li>
                  Adequacy decisions for countries with equivalent privacy
                  protections
                </li>
                <li>
                  Binding Corporate Rules for transfers within our corporate
                  group
                </li>
              </ul>
            </div>
          ...
          <section id="children" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              <p>
                Echo is not intended for children under 13 years of age. We do
          ...
          <section id="contact" style={{ marginBottom: '3rem' }}>
            ...
            <div style={{ color: colorMode === 'dark' ? '#e0e0e0' : '#333' }}>
              ...
              >
                <p>
                  <strong>Email:</strong> privacy@echo.com
                </p>
                <p>
                  <strong>Address:</strong> Echo Inc., 123 Privacy Street, San
                  Francisco, CA 94105
                </p>
                <p>
                  <strong>Data Protection Officer:</strong> dpo@echo.com
                </p>
                <p>
                  <strong>EU Representative:</strong> Echo EU Ltd., Dublin,
                  Ireland
                </p>
              </div>
            </div>
        ...
        >
          ...
          >
            This policy is effective as of December 2024 and applies to all
            users of Echo.
          </p>
        </footer>
      </div>
