                ...
                <li key={route} style={{ position: 'relative' }}>
                  <button
                    ...
                    style={{
                      ...
                      transform:
                        currentRoute === route ? 'scale(1)' : 'scale(0.95)',
            ...
            <button
              ...
              onClick={() => {
                if (langButtonRef.current) {
                  setLangButtonRect(
                    langButtonRef.current.getBoundingClientRect()
                  );
                }
              ...
              <button
                ...
                onClick={() => {
                  if (!isUserMenuOpen && userButtonRef.current) {
                    setUserButtonRect(
                      userButtonRef.current.getBoundingClientRect()
                    );
                  }
            ...
            {supportedLanguages.map((lang) => (
              <button
                ...
                style={{
                  ...
                  background:
                    language === lang.code ? 'var(--accent)' : 'transparent',
