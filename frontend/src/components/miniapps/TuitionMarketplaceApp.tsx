...
export default function TuitionMarketplaceApp({
  isVisible,
  onClose,
}: TuitionMarketplaceAppProps) {
  const [activeTab, setActiveTab] = useState<
    'browse' | 'teachers' | 'insights'
  >('browse');
  ...
  const courses: Course[] = [
    ...
    },
    {
      ...
      description: 'Foundations of organic compounds',
      duration: '14 weeks',
      schedule: ['Wed 5PM', 'Fri 5PM'],
      price: 2800,
      maxStudents: 18,
      enrolled: 14,
      rating: 4.6,
  ...
  const aiInsights = useMemo(() => {
    const avgPrice =
      courses.reduce((acc, c) => acc + c.price, 0) / courses.length;
    ...
    const avgEnrollment = Math.round(
      courses.reduce((acc, c) => acc + (c.enrolled / c.maxStudents) * 100, 0) /
        courses.length
    );
    ...
    return {
      ...
      recommendations: [
        {
          ...
          course: courses.sort(
            (a, b) =>
              a.price / parseInt(a.duration) - b.price / parseInt(b.duration)
          )[0],
        },
      ...
      tips: [
        ...
        avgPrice < 2500
          ? 'Great time to enroll - prices are below average!'
          : 'Premium courses available - invest in quality education.',
      ],
    };
  }, [courses]);
                      ...
                      >
                        ...
                        <span
                          style={{
                            ...
                            borderRadius: '4px',
                            background:
                              course.enrolled / course.maxStudents > 0.8
                                ? 'rgba(255, 71, 87, 0.3)'
                                : 'rgba(46, 213, 115, 0.3)',
                            color:
                              course.enrolled / course.maxStudents > 0.8
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  {selectedCourse.enrolled}/{selectedCourse.maxStudents}
                </div>
                <div
                  style={{
                    fontSize: '0.65rem',
