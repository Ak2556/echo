...
import { searchUsers, searchHashtags, mockUsers, mockHashtags } from '@/utils/textParsing';
  ...
  return (
    ...
    >
      {type === 'mention' ? (
        // Mention suggestions
        <div>
          {(suggestions as ReturnType<typeof searchUsers>).map((user, index) => (
            <button
              key={user.username}
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '8px',
                background: selectedIndex === index ? 'rgba(59, 130, 246, 0.1)' : 'transparent',
                cursor: 'pointer',
                transition: 'all 0.2s',
                textAlign: 'left'
              }}
        ...
        // Hashtag suggestions
        <div>
          {(suggestions as ReturnType<typeof searchHashtags>).map((hashtag, index) => (
            <button
              key={hashtag.tag}
