...
import { Teacher, getTeacherById, courses, Course, reviews } from '@/data/tuitionData';
...
export default function TeacherProfilePage({ teacherId, onBack }: TeacherProfilePageProps) {
  const { t } = useLanguage();
  ...
  const teacherReviews = useMemo(() => {
    ...
    return reviews.filter(review => teacherCourseIds.includes(review.courseId));
  }, [teacherCourses]);

  const averageRating = useMemo(() => {
    if (teacherReviews.length === 0) return teacher?.rating || 0;
    return teacherReviews.reduce((acc, r) => acc + r.rating, 0) / teacherReviews.length;
  ...
  return (
    <section id="teacher-profile" data-route="teacher-profile" className="active">
      <div className="container" style={{ maxWidth: '1400px', margin: '0 auto', padding: '2rem 1rem' }}>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <span>›</span>
            <span style={{ cursor: 'pointer', color: 'var(--accent)' }}>Instructors</span>
            <span>›</span>
          ...
          <div style={{ display: 'flex', gap: '2.5rem', alignItems: 'flex-start' }}>
            ...
            <div style={{ flex: 1 }}>
              <div style={{
                ...
                background: teacher.verified ? 'rgba(16, 185, 129, 0.15)' : 'rgba(156, 163, 175, 0.15)',
                        ...
                        <div style={{ flex: 1 }}>
                          ...
                          <div style={{
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                              <span>⭐</span>
                              <span style={{ fontWeight: 700, color: 'var(--fg)' }}>{course.rating}</span>
                    ...
                    <div style={{ flex: 1 }}>
                      <div style={{ marginBottom: '1rem' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                          <span style={{ fontSize: '0.9rem', minWidth: '60px' }}>5 stars</span>
                          ...
                          <span style={{ fontSize: '0.9rem', minWidth: '40px', textAlign: 'right' }}>
                            {teacherReviews.filter(r => r.rating === 5).length}
                          </span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                          <span style={{ fontSize: '0.9rem', minWidth: '60px' }}>4 stars</span>
                          <div style={{ flex: 1, height: '8px', background: 'var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
                            <div style={{
                          ...
                          <span style={{ fontSize: '0.9rem', minWidth: '40px', textAlign: 'right' }}>
                            {teacherReviews.filter(r => r.rating >= 4 && r.rating < 5).length}
                          </span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                          <span style={{ fontSize: '0.9rem', minWidth: '60px' }}>3 stars</span>
                          <div style={{ flex: 1, height: '8px', background: 'var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
                            <div style={{
                          ...
                          <span style={{ fontSize: '0.9rem', minWidth: '40px', textAlign: 'right' }}>
                            {teacherReviews.filter(r => r.rating >= 3 && r.rating < 4).length}
                          </span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.5rem' }}>
                          <span style={{ fontSize: '0.9rem', minWidth: '60px' }}>2 stars</span>
                          <div style={{ flex: 1, height: '8px', background: 'var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
                            <div style={{
                          ...
                          <span style={{ fontSize: '0.9rem', minWidth: '40px', textAlign: 'right' }}>
                            {teacherReviews.filter(r => r.rating >= 2 && r.rating < 3).length}
                          </span>
                        </div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
                          <span style={{ fontSize: '0.9rem', minWidth: '60px' }}>1 star</span>
                          <div style={{ flex: 1, height: '8px', background: 'var(--border)', borderRadius: '4px', overflow: 'hidden' }}>
                            <div style={{
                          ...
                          <span style={{ fontSize: '0.9rem', minWidth: '40px', textAlign: 'right' }}>
                            {teacherReviews.filter(r => r.rating >= 1 && r.rating < 2).length}
                          </span>
                        </div>
                      </div>
                    </div>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                <div style={{
                  ...
                  <span style={{ fontSize: '0.9rem', color: 'var(--muted)' }}>Total Reviews</span>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.9rem', color: 'var(--muted)' }}>Avg. Rating</span>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.9rem', color: 'var(--muted)' }}>Total Enrollments</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700 }}>
                ...
                <div style={{
                  ...
                  <span style={{ fontSize: '0.9rem', color: 'var(--muted)' }}>Response Time</span>
                  <span style={{ fontSize: '1.1rem', fontWeight: 700 }}>
                    {teacher.responseTime}
                  </span>
                </div>
                ...
                {teacher.totalStudents > 1000 && (
                  <div style={{
                    ...
                    <div>
                      ...
                      <div style={{ fontSize: '0.8rem', color: 'var(--muted)' }}>
                        {(teacher.totalStudents / 1000).toFixed(1)}K+ students taught
                      </div>
                    </div>
                  </div>
                )}
