        ...
        >
          ...
          >
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
              <h3 style={{ margin: 0, fontSize: '1.125rem', fontWeight: 'bold' }}>Notifications</h3>
              {unreadCount > 0 && (
                <button
              ...
              {filteredNotifications.map((notification) => (
                ...
                >
                  ...
                  <div style={{ flex: 1, minWidth: 0 }}>
                    <div style={{ fontSize: '0.9rem', lineHeight: 1.5, marginBottom: '0.25rem' }}>
                      <span style={{ fontWeight: 600 }}>{notification.from.displayName}</span>
                      {notification.from.verified && (
                        <span style={{ color: 'var(--accent)', marginLeft: '0.25rem' }}>✓</span>
                      )}
                      <span style={{ color: 'var(--fg)', opacity: 0.9 }}> {notification.content}</span>
                    </div>
                    <div
                      style={{
                        fontSize: '0.8rem',
