...
import { TrendingUp, TrendingDown, Eye, Heart, Users, MessageCircle, Repeat2, Calendar } from 'lucide-react';
    ...
    <section id="profile-analytics" data-route="profile-analytics">
      <div className="container">
        <div style={{ marginBottom: '2rem' }}>
          <h2 className="nothing-title" style={{ marginBottom: '0.5rem' }}>📊 Profile Analytics</h2>
          <p className="nothing-subtitle">Track your performance and audience insights</p>
        </div>

        {/* Time Range Selector */}
        <div className="nothing-widget" style={{ marginBottom: '2rem', padding: '1rem' }}>
        ...
        <div className="nothing-grid" style={{ marginBottom: '2rem' }}>
          <div className="nothing-widget">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div className="nothing-subtitle" style={{ fontSize: '0.85rem' }}>Profile Views</div>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{
                fontSize: '0.875rem',
                color: analytics.profileViews.trend === 'up' ? '#10b981' : '#ef4444',
                fontWeight: 600
              }}>
                {Math.abs(analytics.profileViews.change)}%
              </span>
              <span style={{ fontSize: '0.875rem', opacity: 0.7 }}>vs last period</span>
            </div>
          </div>
          ...
          <div className="nothing-widget">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div className="nothing-subtitle" style={{ fontSize: '0.85rem' }}>Engagement Rate</div>
                <div className="nothing-title" style={{ fontSize: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{
                fontSize: '0.875rem',
                color: analytics.engagementRate.trend === 'up' ? '#10b981' : '#ef4444',
                fontWeight: 600
              }}>
          ...
          <div className="nothing-widget">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div className="nothing-subtitle" style={{ fontSize: '0.85rem' }}>New Followers</div>
                <div className="nothing-title" style={{ fontSize: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{
                fontSize: '0.875rem',
                color: analytics.followerGrowth.trend === 'up' ? '#10b981' : '#ef4444',
                fontWeight: 600
              }}>
          ...
          <div className="nothing-widget">
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', marginBottom: '0.75rem' }}>
              ...
              <div>
                <div className="nothing-subtitle" style={{ fontSize: '0.85rem' }}>Total Reach</div>
                <div className="nothing-title" style={{ fontSize: '1.75rem' }}>
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              ...
              <span style={{
                fontSize: '0.875rem',
                color: analytics.totalReach.trend === 'up' ? '#10b981' : '#ef4444',
                fontWeight: 600
              }}>
        ...
        <div className="nothing-widget" style={{ marginBottom: '2rem' }}>
          <h3 className="nothing-title" style={{ marginBottom: '1.5rem' }}>Weekly Activity</h3>
          <div style={{ display: 'flex', alignItems: 'flex-end', gap: '1rem', height: '200px' }}>
            {weeklyActivity.map((item) => (
              <div key={item.day} style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem', height: '100%', justifyContent: 'flex-end' }}>
        ...
        <div className="nothing-grid">
          {/* Top Posts */}
          <div className="nothing-widget">
            <h3 className="nothing-title" style={{ marginBottom: '1.5rem' }}>🏆 Top Performing Posts</h3>
              ...
              {topPosts.map((post, index) => (
                <div key={post.id} style={{
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', marginBottom: '0.5rem' }}>
                    ...
                    <span style={{ fontSize: '0.9rem', fontWeight: 600 }}>Rank #{index + 1}</span>
                  </div>
                  <p style={{ fontSize: '0.9rem', marginBottom: '0.75rem', opacity: 0.9 }}>
                    {post.content}
                  </p>
          ...
          {/* Best Times to Post */}
          <div className="nothing-widget">
            <h3 className="nothing-title" style={{ marginBottom: '1.5rem' }}>⏰ Best Times to Post</h3>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
              {bestTimesToPost.map((item) => (
                <div key={`${item.day}-${item.time}`} style={{
                  padding: '1rem',
                  background: 'var(--nothing-surface)',
                  borderRadius: '12px',
                  display: 'flex',
                  ...
                  <div>
                    <div style={{ fontWeight: 600, marginBottom: '0.25rem' }}>{item.day}</div>
                    <div style={{ fontSize: '0.85rem', opacity: 0.7 }}>{item.time}</div>
                  </div>
                  <div style={{
                    padding: '0.5rem 1rem',
                    borderRadius: '8px',
        ...
        <div className="nothing-grid" style={{ marginTop: '2rem' }}>
          <div className="nothing-widget">
            <h3 className="nothing-title" style={{ marginBottom: '1.5rem' }}>👥 Audience by Age</h3>
          ...
          <div className="nothing-widget">
            <h3 className="nothing-title" style={{ marginBottom: '1.5rem' }}>🌍 Audience by Location</h3>
