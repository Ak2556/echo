...
const buttonVariants = {
  ...
  ghost: 'text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 border-transparent',
...
const gradientVariants = {
  ...
  destructive: 'bg-gradient-to-r from-red-600 to-pink-600 hover:from-red-700 hover:to-pink-700',
...
export const FloatingActionButton = forwardRef<HTMLButtonElement, ButtonProps & { 'aria-label': string }>((
