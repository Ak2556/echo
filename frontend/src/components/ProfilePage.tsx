...
export default function ProfilePage() {
  ...
  const userPosts = [
    {
      id: 1,
      content:
        'Excited to share my latest research on AI applications in rural healthcare! 🏥🤖',
    ...
    },
    {
      id: 2,
      content:
        'Beautiful sunset from the Golden Temple today. Punjab never fails to amaze me! 🌅',
    ...
    },
    {
      id: 3,
      content:
        'Working on some amazing new features for Echo! The Nothing Phone UI integration is looking fantastic 📱✨',
      likes: 123,
      comments: 23,
      shares: 8,
  ...
  const [selectedPhotoTab, setSelectedPhotoTab] = useState<
  ...
  const mediaOnly = useMemo(
    () => userPosts.filter((p) => Boolean(p.image)),
    []
  );
  ...
  return (
    ...
    >
      ...
      <div className="container">
        ...
        <div
          className="nothing-widget nothing-glyph-effect modern-card elevation-3 animate-fade-in-down"
          style={{
            marginBottom: '2rem',
            padding: 0,
            overflow: 'hidden',
        ...
        >
          ...
          <div
            className="transition-smooth profile-cover"
            style={{
              height: '280px',
          ...
          >
            ...
            <button
              ...
              style={{
                ...
                fontSize: '1.25rem',
                boxShadow:
                  '0 8px 24px rgba(0, 0, 0, 0.15), 0 4px 12px rgba(102, 126, 234, 0.2)',
                ...
                >
                  <Image
                    ...
                    style={{
                      ...
                      cursor: 'pointer',
                      boxShadow:
                        '0 12px 40px rgba(0, 0, 0, 0.25), 0 6px 20px rgba(0, 0, 0, 0.15), 0 0 0 1px rgba(0,0,0,0.05)',
                      transition: 'all 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)',
                      position: 'relative',
                      zIndex: 10,
                    }}
            ...
            >
              <button
                ...
                style={{
                  ...
                  cursor: 'pointer',
                  boxShadow:
                    '0 4px 16px rgba(102, 126, 234, 0.3), 0 2px 8px rgba(102, 126, 234, 0.2)',
                  transition: 'all 0.3s cubic-bezier(0.4, 0.0, 0.2, 1)',
                  position: 'relative',
                  overflow: 'hidden',
                }}
                ...
                {user.verified && (
                  <div
                    style={{
                      ...
                      fontWeight: '600',
                      boxShadow:
                        '0 4px 12px rgba(102, 126, 234, 0.35), 0 2px 6px rgba(0, 0, 0, 0.15)',
        ...
        <div
          className="nothing-widget premium-insights-banner"
          style={{
            marginBottom: '2rem',
            background:
              'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #f093fb 100%)',
            ...
            padding: '2.5rem',
            boxShadow:
              '0 12px 40px rgba(102, 126, 234, 0.3), 0 6px 20px rgba(118, 75, 162, 0.2)',
            position: 'relative',
            overflow: 'hidden',
          }}
        >
            ...
            {[
              {
                value: formatCompactNumber(
                  profileInsights.profileViews.thisWeek
                ),
                label: 'Profile Views',
              ...
              >
                ...
                <div
                  style={{ fontSize: '1rem', opacity: 0.95, fontWeight: '500' }}
                >
                  {insight.label}
                </div>
                <div
        ...
        <div
          className="nothing-widget premium-tabs-container"
          style={{
            marginBottom: '2rem',
            padding: '1.5rem',
            background:
                  ...
                  >
                    <div style={{ display: 'flex', gap: '1.5rem' }}>
                      ...
                      <button
                        onClick={() =>
                          alert(
                            `Commenting on "${post.content.slice(0, 50)}..."`
                          )
                        }
                        className="premium-post-action"
                        style={{
                      ...
                      <button
                        onClick={() =>
                          alert(`Sharing "${post.content.slice(0, 50)}..."`)
                        }
                        className="premium-post-action"
                        style={{
                          background: 'none',
                    ...
                    <div
                      ...
                      style={{
                        ...
                        background: achievement.earned
                          ? 'var(--nothing-surface)'
                          : 'rgba(var(--nothing-surface-rgb), 0.5)',
                        borderRadius: '16px',
                        border: achievement.earned
                          ? `2px solid ${rarityColors[achievement.rarity as keyof typeof rarityColors]}`
        ...
        {activeTab === 'photos' && (
          <div className="nothing-grid">
            <div className="nothing-widget">
              ...
              >
                <h3 className="nothing-title">
                  📸 Photo Gallery ({photoGallery.length} photos)
                </h3>
                <button
        ...
        {activeTab === 'about' && (
          <div className="nothing-grid">
            <div className="nothing-widget">
              <h3 className="nothing-title" style={{ marginBottom: '1rem' }}>
                {t('profile.about', { name: user.displayName })}
              </h3>
              <div
                style={{
                  background: 'var(--nothing-surface)',
              ...
              >
                <div className="nothing-list-item">
                  <div>
                    <div className="nothing-title" style={{ fontSize: '1rem' }}>
                      Bio
                    </div>
            ...
            <div className="nothing-widget">
              ...
              >
                ...
                >
                  ...
                  >
                    🕰️ Best time to post:{' '}
                    <strong>{profileInsights.bestPostTime}</strong>
                  </div>
                </div>
              </div>
            </div>
            ...
            >
                    ...
                    <div style={{ marginTop: '1rem' }}>
                      ...
                      <div style={{ marginTop: '1rem' }}>
                        <button
                          className="nothing-button primary"
                          onClick={() =>
                            handleSetProfilePhoto(profilePhotoPreview)
                          }
                          style={{ marginRight: '0.5rem' }}
                        >
                          Set as Profile Photo
              ...
              {selectedPhotoTab === 'camera' && (
                <div style={{ textAlign: 'center', padding: '2rem' }}>
                  ...
                  >
                    Camera access required. Please allow camera permissions when
                    prompted.
                  </p>
                </div>
              )}
              ...
              <div style={{ marginBottom: '2rem' }}>
                ...
                >
                  ...
                  <p
                    ...
                    style={{ marginBottom: '1rem' }}
                  >
                    Upload a cover photo (1200x400 recommended)
                  </p>
                  <input
                    type="file"
                    accept="image/*"
