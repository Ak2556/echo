  ...
  return (
    ...
    >
      <SettingsSection
        ...
        description="Manage what content you see"
      >
        <div style={{ marginBottom: 'var(--settings-space-4)' }}>
          ...
          >
            ...
            <option value="moderate">
              Moderate - Show warnings for sensitive content
            </option>
        ...
        <ToggleSwitch
          ...
          description="Allow sensitive content in your feed"
        />
      </SettingsSection>

      <SettingsSection
        title="Media Preferences"
        description="Control how media is displayed"
      >
        <div style={{ marginBottom: 'var(--settings-space-4)' }}>
          <label
            style={{
