...
export function LiveSettings({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <SettingsSubPage
      ...
      onBack={onBack}
    >
      <SettingsSection title="Stream Preferences">
        <ToggleSwitch
          checked={liveNotifications}
          onChange={setLiveNotifications}
          label="Live Notifications"
          description="Alert when followed streamers go live"
        />
        <ToggleSwitch
          checked={chatEnabled}
          onChange={setChatEnabled}
          label="Chat Enabled"
          description="Show chat during live streams"
        />
      </SettingsSection>
      <div
        style={{
