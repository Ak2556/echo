      ...
      <div className="container">
        <div className="hero">
          ...
          <p>
            ...
            interactions, curated content, and meaningful connections.
          </p>
        ...
        <section aria-labelledby="features-heading">
          ...
          <div className="features-grid">
            ...
            >
              ...
              <h3>Smart Feed</h3>
              <p>
                AI-powered content curation that learns from your interests.
                Discover posts, stories, and updates from people and topics you
                care about most.
              </p>
              <div
            ...
            >
              ...
              <p>
                Find amazing creators, join communities, and explore trending
                topics across technology, culture, food, travel, and more.
              </p>
              <div
                className="feature-highlight"
                style={{
            ...
            >
              ...
              <p>
                Join live sessions, workshops, and events. Chat with hosts in
                real-time, participate in Q&As, and be part of interactive
                experiences.
              </p>
              <div
                className="feature-highlight"
            ...
            >
              ...
              <p>
                Connect privately with friends, colleagues, and new connections.
                Share photos, videos, and thoughts in secure, encrypted
                conversations.
              </p>
              <div
                className="feature-highlight"
              ...
              onClick={() => {
                ...
                if (aiChat) {
                  aiChat.style.display =
                    aiChat.style.display === 'none' ? 'flex' : 'flex';
                }
              }}
              style={{ cursor: 'pointer' }}
            >
              ...
              <h3>AI Assistant</h3>
              <p>
                Get help, answers, and creative inspiration from our intelligent
                AI companion. Ask questions, get recommendations, or just have a
                conversation.
              </p>
              <div
                className="feature-highlight"
            ...
            >
              ...
              <p>
                Share your story with photos, videos, carousels, and rich text
                formatting. Express yourself with a full suite of creative
                tools.
              </p>
              <div
                className="feature-highlight"
        ...
        >
          ...
          <div className="trending-grid">
            <div
              className="glass trending-card tilt-card"
              onClick={() => {
                window.location.hash = '#/feed';
            ...
            >
              ...
              <p>
                45.2K posts • AI startups and breakthrough technologies
            ...
            >
              ...
              <p>
                32.8K posts • Navratri, Diwali preparations and cultural
            ...
            >
              ...
              <p>
                28.5K posts • Regional food discoveries and local cuisine
                recommendations
              </p>
            </div>
            <div
            ...
            >
              ...
              <h3>#StartupLife</h3>
              <p>
                19.7K posts • Entrepreneurship journeys and business growth
                stories
              </p>
            </div>
          </div>
          ...
          <div className="activity-grid">
            <div className="glass activity-card">
              <div className="activity-header">
                <Image
                  src="https://api.dicebear.com/7.x/avataaars/svg?seed=Kavya&backgroundColor=b6e3f4&eyes=happy&mouth=smile"
                  alt="Kavya"
              ...
              <p>
                &quot;Just launched my sustainable fashion startup! From
                sketches to reality - 2 years of hard work paying off 🌱👗
                #SustainableFashion #MadeInIndia&quot;
              </p>
            ...
            <div className="glass activity-card">
              <div className="activity-header">
                <Image
                  src="https://api.dicebear.com/7.x/avataaars/svg?seed=Dev&backgroundColor=c0aede&eyes=default&mouth=smile"
                  alt="Dev"
                  className="activity-avatar"
                  width={32}
                  height={32}
              ...
              <p>
                &quot;My grandmother&apos;s 90th birthday celebration was
                magical ✨ 4 generations, endless stories, and the best homemade
                food ever. Family is everything 👴🏽❤️&quot;
              </p>
              <div className="activity-stats">
                <span>❤️ 2.8K</span>
                <span>💬 234</span>
            ...
            <div className="glass activity-card">
              <div className="activity-header">
                <Image
                  src="https://api.dicebear.com/7.x/avataaars/svg?seed=Ananya&backgroundColor=ffd5dc&eyes=wink&mouth=smile"
                  alt="Ananya"
                  className="activity-avatar"
                  width={32}
                  height={32}
              ...
              <p>
                &quot;Monsoon trek to Lonavala was absolutely worth it! 🌧️⛰️
        ...
        <section aria-labelledby="highlights-heading" className="highlights">
          ...
          <div className="highlights-grid">
            <div className="glass highlight-card tilt-card">
              ...
              <h3 data-count="500000" data-plus="true">
                500K+
              </h3>
              <p>Active members engaging daily</p>
            </div>
            <div className="glass highlight-card tilt-card">
              <h3 data-count="1000000" data-plus="true">
                1M+
              </h3>
