    ...
    >
      ...
      >
        ...
        <div style={{ marginLeft: '1rem', flex: 1 }}>
          <Skeleton
            style={{ height: '1rem', width: '150px', marginBottom: '0.5rem' }}
          />
...
export function ProductCardSkeleton() {
  return (
    <div className="modern-card" style={{ padding: '1rem' }}>
      ...
      />
      <Skeleton
        style={{ height: '1.25rem', width: '80%', marginBottom: '0.5rem' }}
      />
      <Skeleton
    ...
    >
      ...
      >
        ...
        <div style={{ flex: 1, paddingBottom: '1rem' }}>
          <Skeleton
            style={{ height: '1.5rem', width: '200px', marginBottom: '0.5rem' }}
          />
      ...
      />
      <Skeleton
        style={{ height: '1rem', width: '80%', marginBottom: '1rem' }}
      />
...
export function StatsCardSkeleton() {
  return (
    <div className="modern-card" style={{ padding: '1.5rem' }}>
      ...
      <Skeleton
        style={{ height: '2rem', width: '80px', marginBottom: '0.5rem' }}
      />
      <Skeleton style={{ height: '0.875rem', width: '100px' }} />
    </div>
  );
...
export function AnalyticsDashboardSkeleton() {
  return (
    <div style={{ padding: '1.5rem' }}>
      {/* Header */}
      <Skeleton
        style={{ height: '2rem', width: '250px', marginBottom: '2rem' }}
      />
      ...
      >
        <Skeleton
          style={{ height: '1.5rem', width: '180px', marginBottom: '1.5rem' }}
        />
      ...
      >
        <div className="modern-card" style={{ padding: '1.5rem' }}>
          <Skeleton
            style={{ height: '1.5rem', width: '200px', marginBottom: '1rem' }}
          />
          <Skeleton style={{ height: '200px', width: '100%' }} />
        </div>
        <div className="modern-card" style={{ padding: '1.5rem' }}>
          <Skeleton
            style={{ height: '1.5rem', width: '150px', marginBottom: '1rem' }}
          />
          <Skeleton style={{ height: '200px', width: '100%' }} />
        </div>
      </div>
...
export function CommentSkeleton() {
  return (
    ...
    >
      ...
      <div style={{ flex: 1 }}>
        <Skeleton
          style={{ height: '0.875rem', width: '120px', marginBottom: '0.5rem' }}
        />
        <Skeleton
          style={{ height: '1rem', width: '100%', marginBottom: '0.25rem' }}
        />
      ...
      {Array.from({ length: rows }).map((_, i) => (
        <div
          ...
          style={{
            ...
            marginBottom: '1rem',
            borderBottom:
              i < rows - 1 ? '1px solid rgba(255, 255, 255, 0.05)' : 'none',
          }}
        >
...
export function FullPageSkeleton() {
  return (
    <div style={{ padding: '2rem', maxWidth: '1200px', margin: '0 auto' }}>
      <Skeleton
        style={{ height: '3rem', width: '300px', marginBottom: '2rem' }}
      />
      <div
