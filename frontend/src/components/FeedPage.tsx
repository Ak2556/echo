...
const feedEchoes = [
  { id: 1, thumbnail: 'https://images.unsplash.com/photo-1611162617474-5b21e879e113?w=300&h=500&fit=crop', username: 'ananya', views: '2.3M', likes: '456K', duration: '0:15' },
  { id: 2, thumbnail: 'https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?w=300&h=500&fit=crop', username: 'techraj', views: '1.8M', likes: '324K', duration: '0:30' },
  { id: 3, thumbnail: 'https://images.unsplash.com/photo-1504674900247-0877df9cc836?w=300&h=500&fit=crop', username: 'priyacooks', views: '3.1M', likes: '567K', duration: '0:22' },
  { id: 4, thumbnail: 'https://images.unsplash.com/photo-1506905925346-21bda4d32df4?w=300&h=500&fit=crop', username: 'rohan', views: '987K', likes: '189K', duration: '0:18' },
];

// Post card component with animations - Memoized for performance
const PostCard = memo(function PostCard({ post, onLike, onComment, onShare, onOptions, index }: {
  post: any;
  onLike: () => void;
  onComment: () => void;
  onShare: () => void;
  ...
  const { createRipple: likeRipple, rippleElements: likeRippleElements } = useRipple();
  const { createRipple: commentRipple, rippleElements: commentRippleElements } = useRipple();
  const { createRipple: shareRipple, rippleElements: shareRippleElements } = useRipple();
  ...
  return (
    ...
    >
      ...
      <div className="feed-header">
        ...
        <button className="feed-options" onClick={onOptions}>⋯</button>
      </div>
      ...
      <div className="feed-content">
        ...
        {post.media && (
          <div style={{ marginTop: '1rem' }}>
            ...
            {post.media.type === 'carousel' && 'images' in post.media && post.media.images && (
              <Carousel
      ...
      <div className="feed-actions" style={{ display: 'flex', gap: '0.75rem', paddingTop: '1rem', borderTop: `1px solid ${colors.border.subtle}` }}>
        <button
          ...
          style={{
            ...
            background: post.liked ? colors.statusBg.error : colors.bg.secondary,
            border: post.liked ? '2px solid colors.status.error' : '2px solid transparent',
...
const feedPosts = [
    ...
    },
    {
      id: 2,
      author: 'Arjun Singh',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Arjun&backgroundColor=c0aede&eyes=default&mouth=smile',
      location: '📍 Golden Temple, Amritsar',
      time: '6 hours ago',
      content: 'Morning seva at the Golden Temple hits different every single time 🙏 There\'s something magical about starting your day in service to others. Whether it\'s helping in the langar kitchen or just being present in this sacred space, it reminds you what really matters. Guru Nanak\'s teachings of equality and compassion feel so relevant today. ✨',
      media: {
        type: 'carousel',
        images: [
    ...
    },
    {
      id: 3,
      author: 'Ravi Kumar',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Ravi&backgroundColor=ffd5dc&eyes=wink&mouth=smile',
      location: '📍 Bangalore, Karnataka',
      time: '8 hours ago',
      content: 'Street food adventures in Bangalore never disappoint! 🌮 Just discovered this incredible dosa cart near Koramangala - the guy makes 47 different types of dosas and each one is pure art. The masala dosa was crispy perfection and don\'t even get me started on their filter coffee ☕ Sometimes the best meals come from the most unexpected places!',
      media: {
        type: 'image',
    ...
    },
    {
      id: 4,
      author: 'Sneha Patel',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Sneha&backgroundColor=ffdfba&eyes=happy&mouth=smile',
      ...
      media: {
        ...
        poster: 'https://images.unsplash.com/photo-1571115764595-644a1f56a55c?w=1200&h=800&fit=crop&crop=center&q=90',
        duration: '1:23'
      },
    ...
    },
    {
      id: 5,
      author: 'Vikram Reddy',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Vikram&backgroundColor=d1c4e9&eyes=default&mouth=smile',
      location: '📍 Hyderabad, Telangana',
      time: '1 day ago',
      content: 'Monsoon magic in the city of pearls! 🌧️ Nothing beats the smell of wet earth and the sight of Hussain Sagar lake during the rains. Stopped by for some authentic Hyderabadi biryani at Paradise - every grain of rice was perfection. Sometimes you need to slow down and appreciate the simple pleasures. The sound of rain on the terrace takes me back to childhood summers at my nani\'s house ❤️',
      media: {
        type: 'image',
    ...
    },
    {
      ...
      media: {
        ...
        src: {
          ...
          '1440p': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4',
          '2160p': 'https://commondatastorage.googleapis.com/gtv-videos-bucket/sample/ElephantsDream.mp4'
        },
        poster: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?w=1200&h=800&fit=crop&crop=center&q=90',
        duration: '2:15'
      },
      tags: ['#Bharatanatyam', '#ClassicalDance', '#Tradition', '#ArtPreservation'],
    ...
    },
    {
      ...
      tags: ['#MeditationRetreat', '#Himalayas', '#Mindfulness', '#SpiritualJourney'],
    ...
    },
    {
      id: 10,
      author: 'Nisha Gupta',
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Nisha&backgroundColor=ffe6f2&eyes=default&mouth=smile',
      location: '📍 Jaipur, Rajasthan',
      time: '3 days ago',
      content: 'Block printing workshop with master craftsmen in the old city was incredible! 🎨 Learning how these intricate patterns are carved by hand, how natural dyes are made from flowers and roots, and watching generations of knowledge passed down through families. Every fabric tells a story of Rajasthani heritage. Supporting local artisans isn\'t just shopping - it\'s preserving culture for future generations 🌸',
      media: {
        type: 'carousel',
        images: [
    ...
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=TechPoll&backgroundColor=a7e6ff&eyes=default&mouth=smile',
      location: '📍 India',
      time: '4 hours ago',
      content: 'Quick poll for all the developers out there! What\'s your preferred programming language for building web applications in 2024? 💻',
      poll: {
        id: 'poll_1',
        question: 'What\'s your preferred programming language for web development in 2024?',
        options: [
    ...
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=FoodExplorer&backgroundColor=ffdfba&eyes=happy&mouth=smile',
      location: '📍 Mumbai, Maharashtra',
      time: '6 hours ago',
      content: 'Settling a debate with friends! What\'s the ultimate Indian street food? Let\'s see what the community thinks! 🍛',
      poll: {
        id: 'poll_2',
    ...
    },
    {
      ...
      avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=TravelEnthusiast&backgroundColor=d1f5d3&eyes=wink&mouth=smile',
      location: '📍 Delhi, India',
      time: '1 day ago',
      content: 'Planning my next adventure! Help me decide where to go for my winter vacation. All these places are on my bucket list! ✈️',
      poll: {
        id: 'poll_3',
...
export default function FeedPage() {
  ...
  const handleCreatePost = () => {
    if (newPost.trim() || uploadedMedia.length > 0) {
      const post: any = {
        id: posts.length + 1,
        author: 'Rajesh Kumar',
        avatar: 'https://api.dicebear.com/7.x/avataaars/svg?seed=Rajesh&backgroundColor=a7e6ff&eyes=happy&mouth=smile',
  ...
  const getVideoMetadata = (file: File): Promise<{duration: string, resolution: string, quality: string}> => {
  ...
  const getImageMetadata = (file: File): Promise<{resolution: string, quality: string}> => {
    return new Promise((resolve) => {
  ...
  const handleFileUpload = async (type: string) => {
    ...
    switch (type) {
      case 'Photo':
        input.accept = 'image/png,image/jpeg,image/webp,image/tiff,image/bmp,image/svg+xml';
        break;
      case 'Video':
        input.accept = 'video/mp4,video/mov,video/avi,video/mkv,video/webm,video/m4v';
        break;
      case 'Audio':
        input.accept = 'audio/wav,audio/flac,audio/aiff,audio/mp3,audio/aac,audio/ogg,audio/m4a';
        break;
      default:
        input.accept = '*/*';
    }
        ...
        try {
          ...
          if (mediaType === 'image') {
            ...
            if (file.size > maxSize) {
              throw new Error(`Video file too large. Maximum size is 100MB, but file is ${formatFileSize(file.size)}.`);
            }
            ...
            if (ext === 'flac' || ext === 'wav' || ext === 'aiff') {
              ...
              const bitrate = (file.size * 8) / (parseFloat(duration.split(':')[0]) * 60 + parseFloat(duration.split(':')[1]));
  ...
  const handlePostOptions = useCallback((postId: number) => {
    const post = posts.find(p => p.id === postId);
    if (post) {
      const action = prompt(
  ...
  return (
    <section id="feed" data-route="feed" className="active animate-fade-in" style={{ position: 'relative' }}>
      ...
      >
        ...
        {/* Stories Carousel */}
        <div className="nothing-widget modern-card animate-fade-in-up" style={{
          marginBottom: '1.5rem',
          padding: '1rem',
          background: 'var(--bg-secondary)',
          borderRadius: '16px'
          ...
          <div style={{ display: 'flex', gap: '0.75rem', overflowX: 'auto', paddingBottom: '0.5rem' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem', flexShrink: 0 }}>
              ...
              <span style={{ fontSize: '0.7rem', color: 'var(--muted)' }}>Your Story</span>
            </div>
            {/* Stories */}
            {feedStories.map(story => (
              <div key={story.id} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.4rem', flexShrink: 0, cursor: 'pointer' }}>
                <div style={{
                  width: '60px',
                  height: '60px',
                  borderRadius: '50%',
                  ...
                  <Image
                    ...
                    height={56}
                    sizes="56px"
                    style={{ borderRadius: '50%', objectFit: 'cover', border: '2px solid var(--bg)' }}
                  />
                  {story.isLive && (
                    <span style={{
                      position: 'absolute',
                      ...
                      left: '50%',
                      transform: 'translateX(-50%)',
                      background: 'linear-gradient(135deg, colors.status.error 0%, #f97316 100%)',
                      color: colors.text.white,
                      fontSize: '0.55rem',
                      fontWeight: 700,
                ...
                <span style={{ fontSize: '0.7rem', color: story.hasNew ? 'var(--fg)' : 'var(--muted)', maxWidth: '60px', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                  {story.username}
                </span>
              </div>
            ))}
        ...
        <div className="nothing-widget modern-card animate-fade-in-up" style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.75rem' }}>
            <h3 style={{ margin: 0, fontSize: '1rem', fontWeight: 600, display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
              <span style={{ background: 'linear-gradient(135deg, colors.brand.primary 0%, colors.brand.secondary 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>📢</span> Echoes
            </h3>
            <button style={{
            ...
            {feedEchoes.map(echo => (
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{ fontSize: '0.65rem', fontWeight: 600 }}>@{echo.username}</div>
                  <div style={{ fontSize: '0.6rem', opacity: 0.8, display: 'flex', gap: '0.4rem' }}>
              ...
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
                          ...
                          {media.type === 'image' ? (
                            <div style={{ position: 'relative' }}>
                              ...
                              <div style={{
                                ...
                                📷 {media.resolution && `${media.resolution} • `}{media.quality && `${media.quality} • `}{media.size}
                              </div>
                            </div>
                          ) : media.type === 'video' ? (
                            <div style={{ position: 'relative' }}>
                              ...
                              <div style={{
                                ...
                                🎥 {media.resolution && `${media.resolution} • `}{media.quality && `${media.quality} • `}{media.duration} • {media.size}
                              </div>
                            </div>
                          ) : (
                            <div style={{
                              ...
                              <div style={{ fontSize: '0.7rem', textAlign: 'center', padding: '0 4px' }}>
                                {media.quality && `${media.quality} • `}{media.duration} • {media.size}
                              </div>
                            </div>
                          )}
                ...
                {isUploading && (
                  <div style={{
                    ...
                    <div style={{ fontSize: '0.9rem', color: 'var(--nothing-text-secondary)' }}>
                ...
                <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                  <button
                    ...
                    style={{
                      opacity: (!newPost.trim() && uploadedMedia.length === 0) ? 0.5 : 1,
                      cursor: (!newPost.trim() && uploadedMedia.length === 0) ? 'not-allowed' : 'pointer'
                    }}
                  >
                    📝 {t('post')}
                  </button>
...
{t('cancel')}
        ...
        <div className="nothing-grid custom-scrollbar" style={{ gridTemplateColumns: '1fr', gap: '1.5rem' }}>
