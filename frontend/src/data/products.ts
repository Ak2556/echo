...
export const PRODUCTS: Product[] = [
  // FASHION & CLOTHING
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: '100% premium cotton t-shirt with modern fit. Breathable, comfortable, and perfect for everyday wear. Pre-shrunk fabric ensures lasting fit.',
    descriptionHi: '100% प्रीमियम कपास टी-शर्ट आधुनिक फिट के साथ। सांस लेने योग्य, आरामदायक और रोज़मर्रा के पहनने के लिए एकदम सही।',
    descriptionPa: '100% ਪ੍ਰੀਮੀਅਮ ਕਪਾਹ ਟੀ-ਸ਼ਰਟ ਆਧੁਨਿਕ ਫਿੱਟ ਨਾਲ। ਸਾਹ ਲੈਣ ਯੋਗ, ਆਰਾਮਦਾਇਕ ਅਤੇ ਰੋਜ਼ਾਨਾ ਪਹਿਨਣ ਲਈ ਸੰਪੂਰਨ।',
    specifications: [
  ...
  },
  {
    ...
    description: 'Premium stretch denim jeans with slim fit. Comfortable 5-pocket design with stylish fading. Perfect for casual and semi-formal occasions.',
    descriptionHi: 'स्लिम फिट के साथ प्रीमियम स्ट्रेच डेनिम जींस। स्टाइलिश फीकेपन के साथ आरामदायक 5-पॉकेट डिज़ाइन। आकस्मिक और अर्ध-औपचारिक अवसरों के लिए सही।',
    descriptionPa: 'ਸਲਿਮ ਫਿੱਟ ਨਾਲ ਪ੍ਰੀਮੀਅਮ ਸਟਰੈਚ ਡੈਨਿਮ ਜੀਨਸ। ਸਟਾਈਲਿਸ਼ ਫੇਡਿੰਗ ਨਾਲ ਆਰਾਮਦਾਇਕ 5-ਜੇਬ ਡਿਜ਼ਾਈਨ।',
    specifications: [
  ...
  },
  {
    ...
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    description: 'Traditional designer kurta with matching pants. Perfect for festivals, weddings, and special occasions. Premium fabric with intricate embroidery.',
    descriptionHi: 'मैचिंग पैंट के साथ पारंपरिक डिज़ाइनर कुर्ता। त्योहारों, शादियों और विशेष अवसरों के लिए एकदम सही। जटिल कढ़ाई के साथ प्रीमियम कपड़ा।',
    descriptionPa: 'ਮੈਚਿੰਗ ਪੈਂਟ ਨਾਲ ਰਵਾਇਤੀ ਡਿਜ਼ਾਈਨਰ ਕੁੜਤਾ। ਤਿਉਹਾਰਾਂ, ਵਿਆਹਾਂ ਅਤੇ ਵਿਸ਼ੇਸ਼ ਮੌਕਿਆਂ ਲਈ ਸੰਪੂਰਨ।',
    specifications: [
  ...
  // ELECTRONICS & TECH
  {
    ...
    description: 'Premium wireless earbuds with active noise cancellation. 30-hour battery life with charging case. IPX7 water resistant. Crystal clear sound quality.',
    descriptionHi: 'एक्टिव नॉइज़ कैंसिलेशन के साथ प्रीमियम वायरलेस ईयरबड्स। चार्जिंग केस के साथ 30 घंटे की बैटरी लाइफ। IPX7 वाटर रेसिस्टेंट।',
    descriptionPa: 'ਐਕਟਿਵ ਸ਼ੋਰ ਰੱਦੀਕਰਨ ਨਾਲ ਪ੍ਰੀਮੀਅਮ ਵਾਇਰਲੈੱਸ ਈਅਰਬੱਡਜ਼। ਚਾਰਜਿੰਗ ਕੇਸ ਨਾਲ 30-ਘੰਟੇ ਦੀ ਬੈਟਰੀ ਲਾਈਫ।',
    specifications: [
  ...
  },
  {
    ...
    description: 'Advanced fitness tracker with heart rate monitor, sleep tracking, and 100+ sport modes. AMOLED display, 7-day battery life, water resistant.',
    descriptionHi: 'हार्ट रेट मॉनिटर, स्लीप ट्रैकिंग और 100+ स्पोर्ट मोड के साथ एडवांस्ड फिटनेस ट्रैकर। AMOLED डिस्प्ले, 7-दिन की बैटरी लाइफ।',
    descriptionPa: 'ਦਿਲ ਦੀ ਧੜਕਣ ਮਾਨੀਟਰ, ਨੀਂਦ ਟਰੈਕਿੰਗ ਅਤੇ 100+ ਖੇਡ ਮੋਡਾਂ ਨਾਲ ਉੱਨਤ ਫਿਟਨੈਸ ਟਰੈਕਰ।',
    specifications: [
  ...
  },
  {
    ...
    brand: 'GameMaster',
    colors: ['Black', 'White'],
    description: 'High-precision wireless gaming mouse with 16,000 DPI sensor. RGB lighting, programmable buttons, ultra-fast response time. Perfect for competitive gaming.',
    descriptionHi: '16,000 DPI सेंसर के साथ हाई-प्रिसिजन वायरलेस गेमिंग माउस। RGB लाइटिंग, प्रोग्रामेबल बटन। प्रतिस्पर्धी गेमिंग के लिए सही।',
    descriptionPa: '16,000 DPI ਸੈਂਸਰ ਨਾਲ ਉੱਚ-ਸਟੀਕਤਾ ਵਾਇਰਲੈੱਸ ਗੇਮਿੰਗ ਮਾਊਸ। RGB ਰੋਸ਼ਨੀ, ਪ੍ਰੋਗਰਾਮੇਬਲ ਬਟਨ।',
    specifications: [
  ...
  },
  {
    ...
    trending: true,
    brand: 'KeyMaster',
    description: 'RGB mechanical gaming keyboard with tactile switches. Full N-key rollover, customizable macros, aircraft-grade aluminum frame. Professional gaming experience.',
    descriptionHi: 'टैक्टाइल स्विच के साथ RGB मैकेनिकल गेमिंग कीबोर्ड। फुल N-key रोलओवर, कस्टमाइज़ेबल मैक्रोज़। प्रोफेशनल गेमिंग अनुभव।',
    descriptionPa: 'ਟੈਕਟਾਈਲ ਸਵਿੱਚਾਂ ਨਾਲ RGB ਮਕੈਨੀਕਲ ਗੇਮਿੰਗ ਕੀਬੋਰਡ। ਪੂਰਾ N-key ਰੋਲਓਵਰ, ਕਸਟਮਾਈਜ਼ੇਬਲ ਮੈਕਰੋ।',
    specifications: [
  ...
  // HOME & LIFESTYLE
  {
    ...
    stock: 150,
    brand: 'LightPro',
    description: 'Adjustable LED desk lamp with touch controls. Multiple brightness levels, eye-care technology, USB charging port. Perfect for studying and working.',
    descriptionHi: 'टच कंट्रोल के साथ एडजस्टेबल LED डेस्क लैम्प। कई ब्राइटनेस लेवल, आई-केयर टेक्नोलॉजी, USB चार्जिंग पोर्ट। पढ़ाई और काम के लिए सही।',
    descriptionPa: 'ਟੱਚ ਕੰਟਰੋਲ ਨਾਲ ਐਡਜਸਟੇਬਲ LED ਡੈਸਕ ਲੈਂਪ। ਕਈ ਚਮਕ ਦੇ ਪੱਧਰ, ਅੱਖਾਂ ਦੀ ਦੇਖਭਾਲ ਤਕਨੀਕ।',
    specifications: [
      { key: 'Type', value: 'LED' },
  ...
  },
  {
    ...
    description: 'Premium TPE yoga mat with excellent grip and cushioning. Non-slip surface, eco-friendly material, includes carrying strap. Perfect for yoga, pilates, and fitness.',
    descriptionHi: 'उत्कृष्ट पकड़ और कुशनिंग के साथ प्रीमियम TPE योग मैट। नॉन-स्लिप सतह, इको-फ्रेंडली सामग्री। योग, पिलेट्स और फिटनेस के लिए सही।',
    descriptionPa: 'ਸ਼ਾਨਦਾਰ ਪਕੜ ਅਤੇ ਗੱਦੀ ਨਾਲ ਪ੍ਰੀਮੀਅਮ TPE ਯੋਗਾ ਮੈਟ। ਨਾਨ-ਸਲਿਪ ਸਤਹ, ਇਕੋ-ਦੋਸਤਾਨਾ ਸਮੱਗਰੀ।',
    specifications: [
  ...
  // ACCESSORIES
  {
    ...
    description: 'Genuine leather wallet with RFID protection. Multiple card slots, coin pocket, and cash compartment. Slim design fits easily in pocket.',
    descriptionHi: 'RFID प्रोटेक्शन के साथ असली लेदर वॉलेट। कई कार्ड स्लॉट, कॉइन पॉकेट और कैश कम्पार्टमेंट। स्लिम डिज़ाइन जेब में आसानी से फिट।',
    descriptionPa: 'RFID ਸੁਰੱਖਿਆ ਨਾਲ ਅਸਲੀ ਚਮੜੇ ਦਾ ਵਾਲੇਟ। ਕਈ ਕਾਰਡ ਸਲਾਟ, ਸਿੱਕੇ ਦੀ ਜੇਬ ਅਤੇ ਨਕਦ ਡੱਬਾ।',
    specifications: [
  ...
  },
  {
    ...
    description: 'Water-resistant laptop backpack with multiple compartments. Padded laptop sleeve (up to 15.6"), USB charging port, ergonomic design. Perfect for work and travel.',
    descriptionHi: 'कई कम्पार्टमेंट के साथ वाटर-रेसिस्टेंट लैपटॉप बैकपैक। पैडेड लैपटॉप स्लीव (15.6" तक), USB चार्जिंग पोर्ट। काम और यात्रा के लिए सही।',
    descriptionPa: 'ਕਈ ਕੰਪਾਰਟਮੈਂਟਾਂ ਨਾਲ ਪਾਣੀ-ਰੋਧਕ ਲੈਪਟਾਪ ਬੈਕਪੈਕ। ਪੈਡਡ ਲੈਪਟਾਪ ਸਲੀਵ (15.6" ਤੱਕ), USB ਚਾਰਜਿੰਗ ਪੋਰਟ।',
    specifications: [
  ...
  },
  {
    ...
    stock: 160,
    brand: 'VisionPro',
    description: 'UV400 polarized sunglasses with scratch-resistant lenses. Stylish aviator design, lightweight frame, includes protective case. Perfect for driving and outdoor activities.',
    descriptionHi: 'स्क्रैच-रेसिस्टेंट लेंस के साथ UV400 पोलराइज्ड सनग्लासेस। स्टाइलिश एविएटर डिज़ाइन, हल्का फ्रेम। ड्राइविंग और आउटडोर गतिविधियों के लिए सही।',
    descriptionPa: 'ਖੁਰਚ-ਰੋਧਕ ਲੈਂਸਾਂ ਨਾਲ UV400 ਪੋਲਰਾਈਜ਼ਡ ਸਨਗਲਾਸ। ਸਟਾਈਲਿਸ਼ ਏਵੀਏਟਰ ਡਿਜ਼ਾਈਨ, ਹਲਕਾ ਫਰੇਮ।',
    specifications: [
  ...
  // BEAUTY & GROOMING
  {
    ...
    stock: 140,
    brand: 'GroomKing',
    description: 'Professional cordless trimmer with 10 attachments. Waterproof design, 90-minute runtime, precision cutting. Perfect for beard, hair, and body grooming.',
    descriptionHi: '10 अटैचमेंट के साथ प्रोफेशनल कॉर्डलेस ट्रिमर। वाटरप्रूफ डिज़ाइन, 90-मिनट रनटाइम। दाढ़ी, बाल और बॉडी ग्रूमिंग के लिए सही।',
    descriptionPa: '10 ਅਟੈਚਮੈਂਟਾਂ ਨਾਲ ਪੇਸ਼ੇਵਰ ਕੋਰਡਲੈਸ ਟ੍ਰਿਮਰ। ਵਾਟਰਪ੍ਰੂਫ ਡਿਜ਼ਾਈਨ, 90-ਮਿੰਟ ਰਨਟਾਈਮ।',
    specifications: [
  ...
  // MOBILE ACCESSORIES
  {
    ...
    trending: true,
    brand: 'ChargePro',
    description: 'High-capacity 20000mAh power bank with fast charging. Dual USB ports, LED display, lightweight design. Can charge smartphone 4-5 times.',
    descriptionHi: 'फास्ट चार्जिंग के साथ हाई-कैपेसिटी 20000mAh पावर बैंक। ड्यूल USB पोर्ट, LED डिस्प्ले। स्मार्टफोन को 4-5 बार चार्ज कर सकता है।',
    descriptionPa: 'ਤੇਜ਼ ਚਾਰਜਿੰਗ ਨਾਲ ਉੱਚ-ਸਮਰੱਥਾ 20000mAh ਪਾਵਰ ਬੈਂਕ। ਦੋਹਰੇ USB ਪੋਰਟ, LED ਡਿਸਪਲੇਅ।',
    specifications: [
  ...
  },
  {
    ...
    stock: 180,
    brand: 'LensPro',
    description: '3-in-1 smartphone lens kit with wide-angle, macro, and fisheye lenses. Universal clip design fits most phones. Professional-quality mobile photography.',
    descriptionHi: 'वाइड-एंगल, मैक्रो और फिशआई लेंस के साथ 3-in-1 स्मार्टफोन लेंस किट। यूनिवर्सल क्लिप डिज़ाइन। प्रोफेशनल-क्वालिटी मोबाइल फोटोग्राफी।',
    descriptionPa: 'ਵਾਈਡ-ਐਂਗਲ, ਮੈਕਰੋ ਅਤੇ ਫਿਸ਼ਆਈ ਲੈਂਸਾਂ ਨਾਲ 3-ਇਨ-1 ਸਮਾਰਟਫੋਨ ਲੈਂਸ ਕਿੱਟ।',
    specifications: [
...
export const CATEGORIES = [
  { id: 'all', name: 'All Products', nameHi: 'सभी उत्पाद', namePa: 'ਸਾਰੇ ਉਤਪਾਦ', icon: '🛍️' },
  { id: 'fashion', name: 'Fashion', nameHi: 'फ़ैशन', namePa: 'ਫੈਸ਼ਨ', icon: '👕' },
  { id: 'electronics', name: 'Electronics', nameHi: 'इलेक्ट्रॉनिक्स', namePa: 'ਇਲੈਕਟ੍ਰਾਨਿਕਸ', icon: '📱' },
  { id: 'home', name: 'Home & Living', nameHi: 'घर और जीवन', namePa: 'ਘਰ ਅਤੇ ਰਹਿਣ', icon: '🏠' },
  { id: 'fitness', name: 'Fitness', nameHi: 'फिटनेस', namePa: 'ਫਿੱਟਨੈਸ', icon: '💪' },
  { id: 'accessories', name: 'Accessories', nameHi: 'एक्सेसरीज़', namePa: 'ਐਕਸੈਸਰੀਜ਼', icon: '🎒' },
  { id: 'grooming', name: 'Grooming', nameHi: 'ग्रूमिंग', namePa: 'ਗਰੂਮਿੰਗ', icon: '✂️' },
  { id: 'mobile', name: 'Mobile Accessories', nameHi: 'मोबाइल एक्सेसरीज़', namePa: 'ਮੋਬਾਈਲ ਐਕਸੈਸਰੀਜ਼', icon: '📲' },
  { id: 'trending', name: 'Trending', nameHi: 'ट्रेंडिंग', namePa: 'ਟ੍ਰੈਂਡਿੰਗ', icon: '🔥' }
];
